...
from .Network import SpatialTransformer, Encoder, RDP, Decoder
...
class U2Model(nn.Module):
    ...
    def build_modules(self):
        ...
        self.content_encoder = Encoder(in_channel=self.opt.in_channel)
        self.decoder = Decoder()
        self.reg = RDP(inshape=self.opt.image_shape,
    ...
    def compute_losses(self, real_A, real_B, c_org_A, c_org_B, fea_A, fea_B):
        ...
        self.loss_recon = self.L1(self.recon_A, real_A)
